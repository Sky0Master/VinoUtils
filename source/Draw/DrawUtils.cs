...
public static class DrawUtils
{
    ...
    public static void DrawCenterText(string content, float existTime = 1f, float fadeDuration = 1f,float offsetX = 0f, float offsetY = 0f)
    {
    ...
    public static void DrawBottomText(string content, float existTime = 1f, float fadeDuration = 1f,float offsetX = 0f, float offsetY = 0f)
    {
        var go = GameObject.Instantiate(Resources.Load("FloatingTextBottom"));
        var fade = go.GetComponent<UICanvasGroupFade>();
        fade.fadeDelay = existTime;
        fade.duration = fadeDuration;
        var tmp = go.GetComponentInChildren<TextMeshProUGUI>();
